...
<!--
	...
	<div id="primary" class="content-area">
		<main id="main" class="site-main" role="main">
			...
			<article>Death rates from falls have risen sharply over the past 10 years, becoming the leading cause of fatal and nonfatal injuries among older adults.</article>

			<h1>60 YEARS OF CARING</h1>

			<p>Xeriberibusae et as esequo blabore pudae. Ut laboreperum hit quunt dolumet, test, soloreribus, que pel ius voluptatur arum Xeriberibusae et as esequo blabore pudae.</p>
			
			<button>See Stories</button>
			
			<article>But even as pension plans and the birth of Social Security began pumping dollars into the aging care system in the mid-1960s, nursing home environments struggled.</article>

...
/**
/*
 * Template Name: Personal Stories Display
 * @package FHCA
 */
get_header()?>
			...
			<?php	endwhile;
					...
					<footer class="page-results-nav clearfix">
						<div class="newer-posts">
					    	<?php previous_posts_link( 'Newer Stories <i class="fa fa-chevron-circle-right"></i>' ); ?>
						</div>
						<div class="older-posts">
							<?php next_posts_link( '<i class="fa fa-chevron-circle-left"></i> Older Stories', $custom_query->max_num_pages ); ?>
						</div>
					</footer>	
			<?php
				wp_reset_postdata();
